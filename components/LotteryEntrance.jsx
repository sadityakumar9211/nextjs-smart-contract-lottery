    ...
    <div className="m-5 font-extralight font-sans">
      ...
      {raffleAddress ? (
        <div>
          ...
          <div>
            Entrance Fees :{ethers.utils.formatUnits(entranceFees, "ether")}{" "}
            ether {/*//this is how we convert from wei to ether.*/}
          </div>
        ...
        <h4 className="text-2xl font-semibold">No Raffle Address Detected!</h4>
      )}
    </div>
  )
}
